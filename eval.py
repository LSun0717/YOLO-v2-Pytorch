...
from Dataset_utils.voc0712 import VOC_CLASSES, VOC_ROOT
from Dataset_utils.cocodataset import coco_root
from Eval_utils.cocoapi_evaluator import COCOAPIEvaluator
from Eval_utils.vocapi_evaluator import VOCAPIEvaluator
...
parser.add_argument('--trained_model', type=str,default='Experiments\\result_experiment\\16_noms\yolov1_150.pth', help='Trained state_dict file path to open')
...
if __name__ == '__main__':
    ...
    if args.version == 'yolo':
        from Model.YOLOv2 import YOLOv1
        net = YOLOv1(device, input_size=input_size, num_classes=num_classes, is_train=False)
